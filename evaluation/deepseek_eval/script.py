...
if tokenizer.pad_token_id is None:
    tokenizer.pad_token_id = tokenizer.eos_token_id  # Use EOS if no PAD is available

# Tokenize input properly
text = "Hello, how are you?"
inputs = tokenizer(text, return_tensors="pt", padding=True, truncation=True).to("mps")  # Adds padding automatically
